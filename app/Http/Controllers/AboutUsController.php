    ...
    public function storeOrUpdate(Request $request)
    {
        ...
        try {
            ...
            $request->validate([
                ...
                'image_1' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:10000',
                'image_1_alt' => 'nullable|string|max:255',
                'image_2' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:10000',
                ...
                'value_section_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:10000',
